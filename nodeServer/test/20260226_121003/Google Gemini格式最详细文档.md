# 🆕 Google Gemini 格式（Generate Content） - New API

Source: https://doc.newapi.pro/api/google-gemini-chat/#_11
Date: 2026-02-25 22:02:52
...
[跳转至](#google-gemini-generate-content)

在
[**GitHub**](https://github.com/QuantumNous/new-api)
[**Gitee**](https://gitee.com/QuantumNous/new-api)
上关注我们的最新动态或加入我们的
[**QQ**](/support/community-interaction/)
交流群

[![logo](../../assets/logo.png)](../.. "New API")
...
* [简体中文](./)
* [English](../../en/api/google-gemini-chat/)
* [日本語](../../ja/api/google-gemini-chat/)
...
* v0.11.0-alpha.9
* 18.2k
* 3.6k](https://github.com/QuantumNous/new-api "前往仓库")
...
* [维基百科](../../wiki/)
  ...
  + 📚 基本概念
    ...
    📚 基本概念
    - [项目介绍](../../wiki/project-introduction/)
    - [特性说明](../../wiki/features-introduction/)
    - [技术架构](../../wiki/technical-architecture/)
    - [网站访问数据分析](../../wiki/analytics-setup/)
  + 📝 项目记录
...
* [使用指南](../../guide/)
  ...
  + 🎯 控制台
    ...
    🎯 控制台
    - [🎮 操练场](../../guide/console/playground/)
    - [💬 聊天](../../guide/console/chat/)
    - [📊 数据看板](../../guide/console/dashboard/)
    - [🔑 API令牌](../../guide/console/api-token/)
    - [📝 使用日志](../../guide/console/usage-log/)
    - [🎨 绘图日志](../../guide/console/drawing-log/)
    - [📝 任务日志](../../guide/console/task-log/)
    - [💰 钱包](../../guide/console/wallet/)
    - [🔧 个人设置](../../guide/console/profile/)
    - [📦 渠道管理](../../guide/console/channel-management/)
    - [🎫 兑换码管理](../../guide/console/redeem-code-management/)
    - [🧑 用户管理](../../guide/console/user-management/)
    - 🔧 系统设置
      ...
      🔧 系统设置
      * [运营设置](../../guide/console/settings/operation-settings/)
      * [仪表盘设置](../../guide/console/settings/dashboard-settings/)
      * [聊天设置](../../guide/console/settings/chat-settings/)
      * [绘图设置](../../guide/console/settings/drawing-settings/)
      * [支付设置](../../guide/console/settings/payment-settings/)
      * [倍率设置](../../guide/console/settings/rate-settings/)
      * [速率限制设置](../../guide/console/settings/rate-limit-settings/)
      * [模型相关设置](../../guide/console/settings/model-settings/)
      * [系统设置](../../guide/console/settings/system-settings/)
      * [其他设置](../../guide/console/settings/other-settings/)
  + [💰 定价](../../guide/pricing/)
  + [📖 文档](../../guide/document/)
  + [📝 关于](../../guide/about/)
* [安装指南](../../installation/)
  ...
  + 🔧 部署方式
    ...
    🔧 部署方式
    - [Docker 部署](../../installation/docker-installation/)
    - [Docker Compose 部署](../../installation/docker-compose-installation/)
    - [1Panel 面板部署](../../installation/1panel-installation/)
    - [宝塔面板部署](../../installation/bt-docker-installation/)
    - [集群部署](../../installation/cluster-deployment/)
    - [本地开发部署](../../installation/local-development/)
  + ⚙️ 配置与维护
    ...
    ⚙️ 配置与维护
    - [系统更新](../../installation/system-update/)
    - [环境变量配置](../../installation/environment-variables/)
    - [Docker Compose 配置文件](../../installation/docker-compose-yml/)
* [接口文档](../)
  ...
  + 中继接口
    ...
    - 💬 聊天（Chat）
      ...
      💬 聊天（Chat）
      * [OpenAI 格式（Chat Completions）](../openai-chat/)
      * [OpenAI 格式（Responses）](../openai-responses/)
      * [Anthropic 格式（Messages）](../anthropic-chat/)
      ...
      * 🆕 Google Gemini 格式（Generate Content）
        ...
        + [🔧 高级功能](#_23)
          ...
          - [引用元数据](#_25)
          - [代码执行](#_26)
          - [接地功能 (Grounding)](#grounding)
          - [多模态处理](#_27)
          - [思考功能](#_28)
          - [语音生成](#_29)
          - [Logprobs 结果](#logprobs)
          - [URL检索功能](#url)
          - [完整安全类别](#_30)
        + [🔍 错误处理](#_31)
    ...
    - 🎥 视频（Video）
      ...
      🎥 视频（Video）
      * [可灵AI (Kling)和即梦 (Jimeng)格式](../kling-jimeng/)
      * [OpenAI 视频格式（Sora格式）](../openai-video/)
  + 查询接口
  ...
  + 前端接口
    ...
    前端接口
    - [鉴权体系说明（Auth）](../auth-system-description/)
    - [获取可用模型列表（Model）](../get-available-models-list/)
    - 接口模块使用指南（Api）
      ...
      接口模块使用指南（Api）
      * [系统初始化模块](../fei-system-initialization/)
      * [公共信息模块](../fei-public-info/)
      * [邮箱身份验证模块](../fei-email-authentication/)
      * [OAuth 第三方登录模块](../fei-oauth-third-party-login/)
      * [用户模块](../fei-user/)
      * [站点配置模块](../fei-site-configuration/)
      * [模型倍率同步模块](../fei-model-rate-sync/)
      * [渠道管理模块](../fei-channel-management/)
      * [Token 管理模块](../fei-token-management/)
      * [兑换码管理模块](../fei-redemption-code-management/)
      * [日志模块](../fei-log/)
      * [数据统计模块](../fei-data-statistics/)
      * [分组模块](../fei-group/)
      * [Midjourney 任务模块](../fei-midjourney-task/)
      * [任务中心模块](../fei-task-center/)
      * [账户计费面板模块](../fei-account-billing-panel/)
* AI应用
  ...
  AI应用
  + [🍒 Cherry Studio - 桌面 AI 客户端](../../apps/cherry-studio/)
  + [📦 LangBot - 即时通信机器人开发平台](../../apps/langbot/)
  + [📱 Factory Droid CLI - AI 命令行开发工具](../../apps/factory-droid-cli/)
  + [📖 FluentRead - 开源翻译插件](../../apps/fluent-read/)
  + [💍 LunaTranslator - 开源GalGame翻译器](../../apps/luna-translator/)
  + [🚀 OpenAI Codex CLI - AI 命令行编码助手](../../apps/codex-cli/)
  + [💻 Claude Code - AI 终端编程助手](../../apps/claude-code/)
* [帮助支持](../../support/)

  帮助支持
  + [🌐 社区交流](../../support/community-interaction/)
  + [🐛 反馈问题](../../support/feedback-issues/)
  + [❓ 常见问题](../../support/faq/)
  + [☕ 请我们喝咖啡](../../support/buy-us-a-coffee/)
...
#### `toolConfig`[¶](#toolconfig "Permanent link")
...
#### `safetySettings`[¶](#safetysettings "Permanent link")
...
#### `systemInstruction`[¶](#systeminstruction "Permanent link")
...
#### `generationConfig`[¶](#generationconfig "Permanent link")
...
#### `cachedContent`[¶](#cachedcontent "Permanent link")
...
### GenerateContentResponse[¶](#generatecontentresponse "Permanent link")

支持多个候选回答的模型的回答。系统会针对提示以及每个候选项报告安全分级和内容过滤。

#### `candidates`[¶](#candidates "Permanent link")
...
#### `promptFeedback`[¶](#promptfeedback "Permanent link")
...
#### `usageMetadata`[¶](#usagemetadata "Permanent link")
...
#### `responseId`[¶](#responseid "Permanent link")

* 类型：字符串
* 说明：用于标识每个响应的ID

#### 完整响应示例[¶](#_22 "Permanent link")
...
## 🔧 高级功能[¶](#_23 "Permanent link")

### 安全评级[¶](#_24 "Permanent link")
...
### 接地功能 (Grounding)[¶](#grounding "Permanent link")
...
### Logprobs 结果[¶](#logprobs "Permanent link")
...
## 🔍 错误处理[¶](#_31 "Permanent link")

### 常见错误码[¶](#_32 "Permanent link")
...
* [关于项目](../../wiki/project-introduction/)
* [联系我们](../../support/community-interaction/)
* [功能特性](../../wiki/features-introduction/)
...
[浙ICP备2025190188号-2](https://beian.miit.gov.cn/)
[![公安备案](https://beian.mps.gov.cn/web/assets/logo01.6189a29f.png)
浙公网安备33010602014019号](http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=33010602014019)

Made with ❤ by
[QuantumNous](https://github.com/QuantumNous/new-api)
